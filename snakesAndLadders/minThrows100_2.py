...
board = [i for	 i in range(0, 10001)]

# Retrieve input from input.txt file
with open("input100.txt") as f:
...
minStepsTo = [10001 for i in range(0, 10001)]
...
prevSquareFor = [(-1, -1) for i in range(0, 10001)]
...
def solve():
	...
	# If path to 10000 exists
	if minStepsTo[10000] < 10001:
		print "Shortest path is " + str(minStepsTo[10000]) + " steps"
		x = 10000
		a = "10000"
